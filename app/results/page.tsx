    ...
    <div className="p-3 sm:p-5">
      <main className="mx-auto max-w-4xl">
        ...
        <section className="px-2 py-10 text-center sm:py-14">
          ...
          <h1 className="font-display text-4xl font-normal sm:text-5xl">Your three countries</h1>
            ...
            return (
              ...
              >
                ...
                <div className="px-6 py-8 sm:px-9">
                  <h2 className="font-display text-3xl font-normal sm:text-4xl">{c.name}</h2>
