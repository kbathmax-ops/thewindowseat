...
insert into lessons (country_id, lesson, summary, source_title, source_author, source_publication, source_url, pull_quote, pull_quote_verbatim) values ('india', 'Embrace the unexpected', 'India kept overturning the writer''s plans and comforts, and met them with generosity anyway. The hard moments were answered by good ones, and they came home feeling stronger.', 'Embrace the Unexpected: What My Trip to India Taught Me About Life', null, 'Intrepid Travel', 'https://www.intrepidtravel.com/adventures/unexpected-india/', 'The hard moments are countered by good ones, and that is what empowers you.', false);
...
insert into lessons (country_id, lesson, summary, source_title, source_author, source_publication, source_url, pull_quote, pull_quote_verbatim) values ('vietnam', 'Chaos has its own order', 'As an expat in Saigon, the writer learned that the traffic runs on an invisible logic. Thousands of riders move as one, and the only way across the street is to step in calmly and trust the flow.', 'Living as an Expat in Vietnam: What I Learned During My Stay', 'Sherry Ott', 'Ottsworld', 'https://www.ottsworld.com/blogs/expat-vietnam-lessons-i-learned/', 'Cross the street like the locals do: steadily, calmly, trusting the flow.', false);
...
insert into country_activities (country_id, position, activity) values ('vietnam', 1, 'Cross a Saigon intersection at rush hour, steadily and without stopping');
...
insert into lessons (country_id, lesson, summary, source_title, source_author, source_publication, source_url, pull_quote, pull_quote_verbatim) values ('thailand', 'Happiness is a daily practice', 'Teaching in Thailand showed the writer why people call it the Land of Smiles. People there choose gratitude in situations that are far from perfect, and discomfort shrinks once you stop treating it as an emergency.', '8 Major Life Lessons Learned in Thailand', null, 'Greenheart Travel', 'https://greenhearttravel.org/blog/teach-abroad-thailand/8-major-life-lessons-learned-in-thailand', 'choose to be grateful — and in turn happy — even in far from perfect situations', true);
...
insert into lessons (country_id, lesson, summary, source_title, source_author, source_publication, source_url, pull_quote, pull_quote_verbatim) values ('nepal', 'Knowing when to stop matters as much as going', 'The Langtang trek taught its writer pacing and humility. You start early, walk steadily, and accept that turning back can be the right call.', 'Hard Lessons from the Langtang Trek: What the Mountains Taught Me', null, 'Nepal Vision Treks', 'https://www.nepalvisiontreks.com/blog-detail/langtang-trek-lessons', 'knowing when to stop is as important as knowing when to go', true);
...
insert into lessons (country_id, lesson, summary, source_title, source_author, source_publication, source_url, pull_quote, pull_quote_verbatim) values ('indonesia', 'Attention is the whole point', 'Days with Balinese locals left the writer with a simple philosophy instead of photos. Give people your full attention, stay in the moment you are in, and protect your rest.', 'Photo Essay of My Trip to Bali, Indonesia', null, 'Myles To Travel', 'https://www.mylestotravel.com/photo-essay-trip-bali-indonesia/', 'The locals'' wisdom: open your heart, stay in the moment, care for yourself.', false);
...
insert into lessons (country_id, lesson, summary, source_title, source_author, source_publication, source_url, pull_quote, pull_quote_verbatim) values ('mongolia', 'Everything moves on', 'The writer trekked the Gobi and Altai with nomadic families and learned to stop needing to know what comes next. Mongolia rewards travelers who can sit with the unknown.', 'My Mongolia Travel Story: An Adventure in Letting Go', 'Kim Merritt', 'WHOA Travel', 'https://www.whoatravel.com/blog-feed/kim-merritt-mongolia-travel-story-gobi-altai', 'The lessons you take away come from what you put in.', false);
...
insert into lessons (country_id, lesson, summary, source_title, source_author, source_publication, source_url, pull_quote, pull_quote_verbatim) values ('jordan', 'Hospitality is the oldest rule of the desert', 'A week in Jordan taught the writer how little headlines and guidebooks capture. The old desert code of feeding the traveler and pouring the tea, with nothing asked in return, still holds.', 'What a Week in Jordan Taught Me About Travelling in Uncertain Times', null, 'Outlook Traveller', 'https://www.outlooktraveller.com/destinations/international/what-a-week-in-jordan-taught-me-about-travelling-in-uncertain-times', 'travel guides only scratch the surface', true);
...
insert into lessons (country_id, lesson, summary, source_title, source_author, source_publication, source_url, pull_quote, pull_quote_verbatim) values ('kenya', 'Emotion is a shared language', 'On a service trip in rural Kenya, the writer found that connection survives a total language gap. A hand on a shoulder, a smile and steady eye contact carried whole conversations.', 'What a Service Trip to Kenya Taught Me About Life', null, 'JourneyWoman', 'https://journeywoman.com/type-of-travel/multi-generational-travel/service-trip/', 'emotions are the vocabulary that connects you', true);
...
insert into lessons (country_id, lesson, summary, source_title, source_author, source_publication, source_url, pull_quote, pull_quote_verbatim) values ('tanzania', 'Presence beats connectivity', 'A year in Tanzania took the writer off the grid and away from constant notifications. Being fully present started to feel normal again, and the people around them felt more familiar than foreign.', 'I Lived in Tanzania for a Year… Here''s What I Learned', null, 'The Pink Backpack', 'https://www.thepinkbackpack.com/lessons-learned-in-tanzania/', 'Disconnecting from technology brought back the joy of simply being present.', false);
...
insert into lessons (country_id, lesson, summary, source_title, source_author, source_publication, source_url, pull_quote, pull_quote_verbatim) values ('south-africa', 'There are no problems, only solutions', 'While travelling South Africa the writer kept running into what locals call the South Africa effect, a practical habit of treating every breakdown as fixable. Things go wrong, and someone always finds a way.', 'Lessons I Learnt While Travelling South Africa', null, 'The Travelling Chilli', 'https://www.thetravellingchilli.com/lessons-learnt-travelling-south-africa/', 'no problems, only solutions', true);
...
insert into lessons (country_id, lesson, summary, source_title, source_author, source_publication, source_url, pull_quote, pull_quote_verbatim) values ('egypt', 'The best trips ignore the itinerary', 'The writer''s Cairo trip was a chain of misadventures that ignored the plan completely. It still turned out to be the kind of trip that changes a person, which the tidy version never would have.', 'Misadventures in Egypt', 'Albion Gould', 'albiongould.com', 'https://albiongould.com/misadventures-in-egypt/', 'An honest account of a trip that refused to go as planned.', false);
...
insert into lessons (country_id, lesson, summary, source_title, source_author, source_publication, source_url, pull_quote, pull_quote_verbatim) values ('ghana', 'Belonging is something you give', 'The writer volunteered in Ghana and learned selflessness from people who practice it by default. Making someone feel welcome turned strangers into friends within days.', 'Lessons Learned in Ghana', null, 'Verge Magazine', 'https://www.vergemagazine.com/volunteer-abroad/blogs/982-lessons-learned-in-ghana.html', 'Helping someone feel they belong is the fastest way to make a friend.', false);
...
insert into lessons (country_id, lesson, summary, source_title, source_author, source_publication, source_url, pull_quote, pull_quote_verbatim) values ('italy', 'The sweetness of doing nothing', 'A trip to Italy taught the writer il dolce far niente. Long meals and evening walks are treated as the point of the day there, and the writer came home trying to keep the habit.', 'I Discovered the Art of Slow Living on a Trip to Italy. Here''s How I''m Trying to Hold On to It at Home', null, 'VegOut Magazine', 'https://vegoutmag.com/travel/r-i-discovered-the-art-of-slow-living-on-a-trip-to-italy-heres-how-im-trying-to-hold-on-to-it-at-home/', 'Life is meant to be lived, not just efficiently processed.', false);
...
insert into lessons (country_id, lesson, summary, source_title, source_author, source_publication, source_url, pull_quote, pull_quote_verbatim) values ('france', 'Small pleasures are the point', 'Years in France taught the writer les petits plaisirs. A good baguette, a slow coffee and an unhurried errand count as real life there, and nobody seems worse off for refusing to rush.', 'What the French Taught Me About Enjoying Life', null, 'Oui In France', 'https://www.ouiinfrance.com/what-the-french-taught-me-about-enjoying-life/', 'little doses of pleasure that allow you to enjoy life to the fullest', true);
...
insert into lessons (country_id, lesson, summary, source_title, source_author, source_publication, source_url, pull_quote, pull_quote_verbatim) values ('spain', 'Freedom reveals who you are', 'After moving to Spain, the writer rediscovered a playful side and old passions that home had buried. The essay treats joy as a birthright rather than a reward.', 'Moving Abroad to Spain Taught Me That When I''m Free, I Am Whimsical', null, 'Black Babes Abroad', 'https://blackbabesabroad.substack.com/p/moving-abroad-to-spain-taught-me', 'A new place can reconnect you with passions you thought you''d outgrown.', false);
...
insert into lessons (country_id, lesson, summary, source_title, source_author, source_publication, source_url, pull_quote, pull_quote_verbatim) values ('portugal', 'Community is something you build', 'Three years in Portugal showed the writer how much room a slower pace leaves for building community on purpose. Becoming a regular somewhere turned out to be the whole point of staying.', '10 Things I''ve Learned Living in Portugal for 3 Years', 'Stacy Ennis', 'stacyennis.com', 'https://stacyennis.com/10thingsportugal/', 'The slower pace makes room for the things that actually matter.', false);
...
insert into lessons (country_id, lesson, summary, source_title, source_author, source_publication, source_url, pull_quote, pull_quote_verbatim) values ('greece', 'Guests come before schedules', 'In Greece the writer met a culture that refuses to rush a guest. Hospitality comes before schedules there, and the exposure changed the writer''s sense of what a day is for.', 'Lessons Learned in Greece', null, 'Her Campus (West Chester)', 'https://www.hercampus.com/school/west-chester/lessons-learned-in-greece/', 'People are more relaxed, and hospitality comes before everything else.', false);
...
insert into country_activities (country_id, position, activity) values ('greece', 1, 'Accept the taverna owner''s second helping, since arguing is futile');
...
insert into lessons (country_id, lesson, summary, source_title, source_author, source_publication, source_url, pull_quote, pull_quote_verbatim) values ('ireland', 'Embrace the rain', 'The writer travelled Ireland alone and picked up the local attitude toward rain: put on a coat and carry on. The weather stopped being a reason to wait, and so did most other things.', 'Solo Travel Ireland: 9 Interesting Lessons Learned', null, 'Solo Traveler World', 'https://solotravelerworld.com/solo-travel-ireland/', 'Locals take the rain in stride, so you learn to as well.', false);
...
insert into lessons (country_id, lesson, summary, source_title, source_author, source_publication, source_url, pull_quote, pull_quote_verbatim) values ('mexico', 'Trust, joy and gratitude are daily practices', 'The writer lived in Mexico through the pandemic and learned trust, joy and gratitude from neighbors who practice all three daily. Plans flex there, and the good parts of life get shared.', 'What Living in Mexico Taught Me About Trust, Joy and Gratitude During the Pandemic', null, 'JourneyWoman', 'https://journeywoman.com/destinations/north-america/mexico/five-lessons-learned-living-in-mexico-during-the-pandemic/', 'Mexico gave me courage to keep travelling.', false);
...
insert into lessons (country_id, lesson, summary, source_title, source_author, source_publication, source_url, pull_quote, pull_quote_verbatim) values ('cuba', 'Make the most of what you have', 'Nine days in Cuba showed the writer resourcefulness as a national habit. Old cars stay running on ingenuity, music gets made with whatever is at hand, and joy there does not wait for plenty.', 'What Traveling to Cuba Taught Me About Life, and Making the Most of It', null, 'Intrepid Travel', 'https://www.intrepidtravel.com/adventures/travel-cuba-life-lessons/', 'Life here is about making the most of it.', false);
...
insert into lessons (country_id, lesson, summary, source_title, source_author, source_publication, source_url, pull_quote, pull_quote_verbatim) values ('colombia', 'Warmth is a way of life', 'Six months in Colombia taught the writer two lessons that turned out to be one. Buses and plans run late, and the people are warm enough that the lateness stops mattering.', '6 Lessons Learned From Living in Colombia for Six Months', 'Madalyne Loree', 'Backroad Packers (Medium)', 'https://backroadpackers.medium.com/6-lessons-learned-from-living-in-colombia-for-six-months-88408060decd', 'Be okay with things not always being on time.', false);
...
insert into lessons (country_id, lesson, summary, source_title, source_author, source_publication, source_url, pull_quote, pull_quote_verbatim) values ('argentina', 'Joy doesn''t wait for ease', 'The writer studied abroad in Buenos Aires and saw real hardship next to real happiness every day. Generosity there is reflexive, from a shared gourd of mate to an asado invitation for whoever is around.', 'Studying Abroad in Buenos Aires, Argentina: Changes in Perspective', 'Prasanna Karur', 'Medium', 'https://medium.com/@pkarur/studying-abroad-in-buenos-aires-argentina-changes-in-perspective-be158116ba57', 'They struggle, but they are happy', true);
...
insert into lessons (country_id, lesson, summary, source_title, source_author, source_publication, source_url, pull_quote, pull_quote_verbatim) values ('new-zealand', 'Nature resets your scale', 'Early hikes, mountain sunsets and meteor showers showed the writer what natural beauty at full scale feels like. New Zealand made their problems feel smaller and the outdoors feel necessary.', 'A Trip to New Zealand Taught Me the True Beauty of Nature', null, 'Contiki six-two', 'https://www.contiki.com/six-two/article/new-zealand-natural-beauty/', 'Sunset from Mount Ruapehu, meteor showers overhead. Nature at full volume.', false);
...
insert into lessons (country_id, lesson, summary, source_title, source_author, source_publication, source_url, pull_quote, pull_quote_verbatim) values ('australia', 'Silence teaches you to trust yourself', 'Days alone in the outback stripped the writer down to essentials. In that much silence the writer started trusting their intuition again, a signal that screens and schedules usually drown out.', '16 Massive Life Lessons I Learned in the Australian Outback', 'Bryan Reeves', 'bryanreeves.com', 'https://bryanreeves.com/16-massive-life-lessons-i-learned-in-the-australian-outback/', 'trusting my intuition', true);
...
insert into lessons (country_id, lesson, summary, source_title, source_author, source_publication, source_url, pull_quote, pull_quote_verbatim) values ('vanuatu', 'Enough is plenty', 'Six weeks in a remote Vanuatu village introduced the writer to people with little money and no appetite for more of it. They were content and proud, and the visit permanently changed the writer''s view of work and community.', 'Life Lessons from a Remote Paradise: Six Weeks in Vanuatu Village', 'Stevo Perry', 'Medium', 'https://stevenperryau.medium.com/life-lessons-from-a-remote-paradise-six-weeks-in-vanuatu-village-41d717704593', 'more than content with what they had – and proud of it', true);
...
insert into lessons (country_id, lesson, summary, source_title, source_author, source_publication, source_url, pull_quote, pull_quote_verbatim) values ('papua-new-guinea', 'Courage over comfort', 'The writer calls the trip a masterclass in courage. Papua New Guinea is remote and raw, and doing hard things there without any cushions is what produced the growth.', 'Courage Over Comfort: What Papua New Guinea Taught Me About Doing Hard Things', 'Laura Beauparlant', 'laurabeauparlant.com', 'https://www.laurabeauparlant.com/blog/courage-over-comfort-what-papua-new-guinea-taught-me-about-doing-hard-things', 'a masterclass in courage', true);
